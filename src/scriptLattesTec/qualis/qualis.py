...
import re
import fileinput
from scriptLattesTec import *
from scriptLattesTec.util import similaridade_entre_cadeias, buscarArquivo
...
class Qualis:
    ...
    def __init__(self, grupo):
        if grupo.obterParametro('global-arquivo_qualis_de_periodicos'):
    ...
    def buscaQualis(self, tipo, nome, sigla=''):
        dist = 0
        indice = 0
        # Percorrer lista de periodicos tentando casar com nome usando funcao similaridade_entre_cadeias(str1,
        # str2) de scriptLattes.py
        if tipo == 'P':
