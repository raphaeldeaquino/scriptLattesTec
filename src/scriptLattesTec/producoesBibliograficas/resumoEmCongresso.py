...
class ResumoEmCongresso:
    ...
    def csv(self):
        ...
        s += (self.nomeDoEvento + '\t' if self.nomeDoEvento else '\t')
        s += str(self.ano) + "\t"
    ...
    def colunas_csv(self):
        return 'ID_MEMBRO' + '\t' + 'RELEVANTE' + '\t' + 'DOI' + '\t' + 'AUTORES' + '\t' + 'TITULO' + '\t' + 'NOME EVENTO' \
               + '\t' + 'ANO' + '\t' + 'VOLUME' + '\t' + 'NUMERO' + '\t' + 'PAGINAS' + '\t' + 'ITEM'
